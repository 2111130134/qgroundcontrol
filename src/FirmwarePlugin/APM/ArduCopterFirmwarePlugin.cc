    ...
    : APMFirmwarePlugin(parent)
{
    ...
    static FlightModeList availableFlightModes = {
        ...
        { _stabilizeFlightMode   , APMCopterMode::STABILIZE,     false, true },
        { _acroFlightMode        , APMCopterMode::ACRO,          false, true },
        ...
        { _circleFlightMode      , APMCopterMode::CIRCLE,        false, true },
        { _landFlightMode        , APMCopterMode::LAND,          true , true },
        { _driftFlightMode       , APMCopterMode::DRIFT,         false, true },
        { _sportFlightMode       , APMCopterMode::SPORT,         false, true },
        { _flipFlightMode        , APMCopterMode::FLIP,          false, true },
        { _autotuneFlightMode    , APMCopterMode::AUTOTUNE,      false, true },
        { _posHoldFlightMode     , APMCopterMode::POS_HOLD,      true , true },
        { _brakeFlightMode       , APMCopterMode::BRAKE,         true , true },
        { _throwFlightMode       , APMCopterMode::THROW,         false, true },
        { _avoidADSBFlightMode   , APMCopterMode::AVOID_ADSB,    false, true },
